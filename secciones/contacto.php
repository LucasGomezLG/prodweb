...
<section id="Contacto">
    <div class="contacto-bg">
        <div class="container bg-dark p-3 mb-5 mt-3 txt-w">
                    ...
                    <form action="enviar.php" method="POST">
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2 floating-label-form-group-with-value">
                                ...
                                <input class="form-control" name="telefono" id="phone" type="tel" placeholder="+5491126030887" required="required" data-validation-required-message="Please enter your phone number." aria-invalid="false">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2 floating-label-form-group-with-value">
                                <label>Área de la empresa que se comunica</label>
                                <input class="form-control" name="area" id="area" type="area" placeholder="Recursos humanos" required="required" data-validation-required-message="Please enter your work site." aria-invalid="false">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <!-- Consulta -->
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2 floating-label-form-group-with-value">
                                ...
                                <textarea class="form-control" name="consulta" id="message" rows="5" placeholder="Escribe tu consulta aqui" required="required" data-validation-required-message="Please enter a message." aria-invalid="false"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
