...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center h1-x mt-4 mb-4">Modificar categoria</h1>
            </div>    
            ...
            <div class="col-6 offset-3">
                ...
                <div>
                   ...
                   <div class="form_container">
                        <form action="index.php?seccion=modificar_categoria" method="POST" class="bg-dark p-3 mb-5 mt-3">
                        
                        <input type='hidden' name='id_categoria' value='<?php echo $_POST['id_categoria'] ?>' /> 
                        <div class="form-row">
                        <div class="form-group mb-3 col-6">
                            <input type="text" name="nombre" max="3" id="nombre" class="form-control" >
                        </div>    
